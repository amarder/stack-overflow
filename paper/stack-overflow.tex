...
\citet{Kraft-Todd} survey the literature on field experiments aimed at
promoting cooperation in social dilemmas (voter turnout, environmental
protection, universal healthcare, \dots). Table \ref{tab:kraft-todd}
describes the four categories used to classify the interventions
surveyed. I use the same classifications to consider why users
...
Why do users contribute to Stack Overflow? The four categories of Table \ref{tab:kraft-todd} provide potential reasons:
\begin{enumerate}
\item Material rewards: You might contribute to Stack Overflow to
  signal your technical ability to potential employers. By
  contributing to Stack Overflow you increase the probability of
  finding better employment opportunities, leading to material
  rewards.
\item Increased efficacy: By emphasizing how your contributions to the
  site benefit others - providing high quality answers helps others
  save time when solving similar problems - you may be motivated to
  contribute.
\item Observability: Since others are informed about your contribution
  decisions, you will be motivated to contribute if you want others
  to perceive you as generous.
\item Descriptive norms: If you are concerned about how your
  contributions compare to the contributions of others,
  the reputation leaderboards may spark your competitive drive.
\end{enumerate}
This is not an exhaustive list of why users contribute to Stack Overflow. But, it will be useful when considering why users increase contributions around receiving certain badges and not others.
